                                ...
                                item.children ? (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Icon
                                                name="expand_more"
                                                className="mb-0.5 ml-1 h-4 w-4 transition-transform group-hover:rotate-180 group-hover:text-primary"
                                            />
                                        </button>

                                        <div className="invisible absolute right-0 top-full z-50 w-48 origin-top-right scale-95 pt-2 opacity-0 transition-all duration-200 group-hover:visible group-hover:scale-100 group-hover:opacity-100">
