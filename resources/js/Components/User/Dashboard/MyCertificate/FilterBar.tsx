...
interface FilterBarProps {
    ...
    onFilterChange: (value: CertificateFilterOption) => void;
    sortBy: CertificateSortOption;
    onSortChange: (value: CertificateSortOption) => void;
}

const SORT_OPTIONS: { value: CertificateSortOption; label: string }[] = [
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
                <SelectDropdown
                    value={sortBy}
                    onChange={(value) =>
                        onSortChange(value as CertificateSortOption)
                    }
